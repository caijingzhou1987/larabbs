...
<div class="container">
    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="nav-item notification-badge">
            <a class="nav-link mr-3 badge badge-pill badge-{{ Auth::user()->notfication_count > 0 ? 'hint' : 'secondary' }} text-white" href="{{ route('notifications.index') }}">
              {{ Auth::user()->notfication_count}}
            </a>
        </li>
